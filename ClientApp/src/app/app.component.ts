...
export class AppComponent implements OnInit {
  ...
  get canViewDiscoveryDocument(){
    return true;
  }

  get canViewMyProfile(){
    return true;
  }

  get canViewMyPersonalData(){
    return true;
  }

  get canViewTwoFactorAuthentication(){
    return true;
  }

  get canViewChangePassword(){
    return true;
  }
  ...
  get canViewIdentityResources() {
    return this.accountService.userHasPermission(Permission.viewRolesPermission);
  }
  get canViewApiResources() {
    return this.accountService.userHasPermission(Permission.viewRolesPermission);
  }
  get canViewPersistedGrants() {
    return this.accountService.userHasPermission(Permission.viewRolesPermission);
  }
}
