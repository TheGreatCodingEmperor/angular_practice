...
namespace UltraApp
{
    ...
    {
        public const string ApiName = "ultraapp_api";
        public const string ApiFriendlyName = "UltraApp API";
        public const string UltraAppClientID = "ultraapp_spa";
        ...
        public static IEnumerable<Client> GetClients()
        {
            ...
            return new List<Client>
            {
                ...
                new Client
                {
                    ClientId = IdentityServerConfig.UltraAppClientID,
