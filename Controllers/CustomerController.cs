...
namespace UltraApp.Controllers
{
    ...
    public class CustomerController : ControllerBase
    {
        ...
        {
            string recepientName = "UltraApp Tester"; //         <===== Put the recepient's name here
            string recepientEmail = "test@eXentric.work"; //   <===== Put the recepient's email here

            string message = EmailTemplates.GetTestEmail(recepientName, DateTime.UtcNow);

            (bool success, string errorMsg) = await _emailSender.SendEmailAsync(recepientName, recepientEmail, "Test Email from UltraApp", message);
